...
const translations = {
  ar: {
    ...
    'homepage.how.it.works.title': 'كيف تعمل المنصة؟',
    'homepage.how.it.works.description': 'رحلة تفاعلية بسيطة تقودك إلى حلمك الجامعي خطوة بخطوة - من التسجيل إلى القبول',
    ...
    'homepage.faq.description': 'إجابات على أكثر الأسئلة شيوعاً حول خدماتنا وعملية التقديم',
    ...
    'homepage.testimonial.video': 'فيديو الشهادة',
    'homepage.join.today': 'انضم إلينا اليوم',
    'homepage.choose.path': 'اختر المسار المناسب لك',
    'homepage.choose.path.description': 'سواء كنت طالباً تبحث عن فرصتك الأكاديمية أو وكيلاً ترغب في مساعدة الطلاب، لدينا ما يناسبك',
    'homepage.for.students': 'للطلاب',
    'homepage.student.description': 'تقديمك يبدأ هنا — استكشف الجامعات العالمية بنقرة واحدة',
    'homepage.students.feature.universities': '500+ جامعة عالمية',
    'homepage.students.feature.programs': '1000+ تخصص دراسي',
    'homepage.students.feature.secure': 'تقديم آمن ومضمون',
    'homepage.students.feature.fast': 'قبول سريع خلال أيام',
    'homepage.register.student': 'سجّل كطالب',
    'homepage.start.free': 'ابدأ مجاناً',
    'homepage.for.agents': 'للوكلاء',
    'homepage.agent.description': 'هل أنت وكيل؟ قم بمساعدة الطلاب واحصل على عمولات مجزية',
    'homepage.agents.feature.commission': 'عمولات مجزية',
    'homepage.agents.feature.support': 'دعم فني متكامل',
    'homepage.agents.feature.clients': 'عملاء من 50+ دولة',
    'homepage.agents.feature.certified': 'شهادة وكيل معتمد',
    'homepage.certified.agent': 'وكيل معتمد',
    'homepage.commission.rate': 'نسبة العمولة',
    'homepage.tech.support': 'دعم فني',
    'homepage.join.agent': 'انضم كوكيل',
    'homepage.rewarding.commissions': 'عمولات مجزية',
  ...
  en: {
    ...
    'homepage.how.it.works.title': 'How does the platform work?',
    'homepage.how.it.works.description': 'A simple interactive journey that leads you to your university dream step by step, from registration to acceptance',
    ...
    'homepage.faq.description': 'Answers to the most common questions about our services and application process',
    'homepage.support.description': 'Our support team is available around the clock to answer your questions and help with your educational journey',
    'homepage.testimonial.video': 'Testimonial video',
    'homepage.join.today': 'Join us today',
    'homepage.choose.path': 'Choose the right path for you',
    'homepage.choose.path.description': 'Whether you are a student looking for your academic opportunity or an agent helping students, we have the right path for you',
    'homepage.for.students': 'For Students',
    'homepage.student.description': 'Your application starts here. Explore global universities with one click',
    'homepage.students.feature.universities': '500+ global universities',
    'homepage.students.feature.programs': '1000+ study programs',
    'homepage.students.feature.secure': 'Secure application process',
    'homepage.students.feature.fast': 'Fast acceptance within days',
    'homepage.register.student': 'Register as a student',
    'homepage.start.free': 'Start for free',
    'homepage.for.agents': 'For Agents',
    'homepage.agent.description': 'Are you an agent? Help students and earn rewarding commissions',
    'homepage.agents.feature.commission': 'Rewarding commissions',
    'homepage.agents.feature.support': 'Full technical support',
    'homepage.agents.feature.clients': 'Clients from 50+ countries',
    'homepage.agents.feature.certified': 'Certified agent badge',
    'homepage.certified.agent': 'Certified agent',
    'homepage.commission.rate': 'Commission rate',
    'homepage.tech.support': 'Technical support',
    'homepage.join.agent': 'Join as an agent',
    'homepage.rewarding.commissions': 'Rewarding commissions',
