...
const translations = {
  ar: {
    ...
    'contact.form.description': 'Send us your message and we will get back to you as soon as possible',
    ...
    'contact.form.phone.required': 'Phone number is required',
